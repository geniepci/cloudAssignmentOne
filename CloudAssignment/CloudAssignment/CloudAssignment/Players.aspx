<%@ Page Language="C#" AutoEventWireup="true" MasterPageFile="~/Site.Master" CodeBehind="Players.aspx.cs" Inherits="CloudAssignment.Players" %>
        ...
        <div class ="jumbotron">
           ...
           <h2>ADD A PLAYER</h2> </div>
                ...
                <asp:DataList 
                    ...
                    ForeColor="#333333" GridLines="Both" style="margin-right: 0px; width: 600px;" RepeatDirection="Horizontal" RepeatColumns="7">
                ...
                <asp:ObjectDataSource 
                   ...
                   TypeName="CloudAssignment.Players" 
