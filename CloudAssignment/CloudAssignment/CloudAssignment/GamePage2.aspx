<%@ Page Language="C#" AutoEventWireup="true" MasterPageFile="~/Site.Master" CodeBehind="GamePage2.aspx.cs" Inherits="CloudAssignment.GamePage2" %>
...
<asp:Label ID="Label1" runat="server" ></asp:Label>
                                ...
                                <asp:ObjectDataSource ID="playerData" runat="server" SelectMethod="GetPlayers" TypeName="CloudAssignment.Players"></asp:ObjectDataSource>
